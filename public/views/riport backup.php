...
$(document).ready(function(){
    ...
    $("#tabel2").on("click","tbody tr td", function(){
           ...
           // get_header_detail(tahun,divisi);
                                        ...
                                        lengthMenu: [[5, 10, 20, -1], [5, 10, 20, 'All']],
                                            ...
                                            { 'data': 'divisi' },
                                                ...
                                                "render" : function(data,type,row,meta){
                                                    if(type === 'display'){
                                                        data = '<a id="data_tahun href="' + data + '" target="_blank">' + data + '</a>';
                                                    }
                                                    return data;
                                                }
                                                },
...
function get_tables_all(tahun,div){
        ...
        <section class="section">
                ...
                <div class="card-header">
                    ...
                    <table id="tabel2" style="cursor:pointer" class='display table-info' >
...
function get_tables_detail_all(){
            let dataTable =`
            <section class="section">
                    <div class="card">
        ...
        <section class="section">
                            <form id="filter_data">
                                <div class=" row col-md-10">
                                    ...
                                    <div class="col-md-2">
                                    <button  type="sumbit" name="sumbit" class="btn btn-primary" id="sumbit">Sumbit</button>
                                    </div>
                                </div>
                            </form>
