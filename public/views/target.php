...
<?php include 'views/pages/burger.php' ?>
  ...
  <div class ="col-md-12 col-12">
            ...
            <div class="col-md-12 text-end">
                            <button type="button" class="btn btn-lg tambah-data" data-bs-toggle="modal" data-bs-target="#TambaModal">
        ...
        <form  id ="formtambah" enctype="multipart/form-data" action="" method="POST" class ="form form-horizontal">
                <div class ="row col-md-12 mb-2">
                        <label class="col-sm-3 col-form-label" >Divisi</label>
                          <div id="divisi_tambah" class ="col-md-2"></div>
    ...
    <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" id="close_delete" aria-label="Close"></button>
                ...
                <div class="modal-body">
                  ...
                  <div class ="row col-md-12 mb-2">
                    <label class="col-sm-3 col-form-label" >Divisi</label>
                    <div  id="divisi_delete" class ="col-md-2"></div>
                  ...
                  <div class ="row col-md-12 mb-3">
                    ...
                    <div class="row col-md-12 mb-3">
                      ...
                      <div class="col-sm-11 d-flex justify-content-end">
                            ...
                            <button type="button" class="btn btn-secondary me-1 mb-3" id="close_delete2" data-bs-dismiss="modal">Close</button>
                        </div>
    ...
    <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" id="close" aria-label="Close"></button>
                ...
                <div class="modal-body">
                  ...
                  <div class ="row col-md-12 mb-2">
                    <label class="col-sm-3 col-form-label" >Divisi</label>
                    <div id="divisi_edit" class ="col-md-2"></div>
                  </div>
                  <div class ="row col-md-12 mb-3">
                          <label for="tahun" class="col-sm-3 col-form-label">Year</label>
                          <div class="col-md-3">
...
$(document).ready(function(){
  const dateya = new Date();
    ...
    getbulan(tahun);
    tahun_edit();
    get_data_divisi_edit();
    get_data_divisi_delete();
...
//tambah data
  ...
  //end tambah data
    ...
    let id_div =".modal-body " + "#"+divisi;
    $(id_div).prop("checked",true);
    $(".divisi_edit").attr("disabled", true);
...
$("#close_delete2").on("click",function(e){
  e.preventDefault();
  $("#formdelete").trigger("reset");
});
            ...
            success:function(response){
                ...
                $.each(response,function(key,value){
                  ...
                  <div class="form-check form-check-inline">
                                  <input class="form-check-input check${div}" for ="${divisi}" type="checkbox" id="${divisi}" name="divisi" value="${divisi}" required>
...
// UNTUK MENAMILKAN DATA DIVISI EDIT
function get_data_divisi_edit(){
  ...
  $.ajax({
          ...
          success:function(response){
              ...
              $.each(response,function(key,value){
                ...
                data +=`
                <div class="form-check form-check-inline">
                                <input class="form-check-input divisi_edit" for ="${divisi}" type="checkbox" id="${divisi}" name="divisi" value="${divisi}" required>
                                <label class="form-check-label" for ="${divisi}">${divisi}</label>
                    </div>
                `;

              });
              $("#divisi_edit").empty().html(data);  
          }
...
//END DATA DIVISI
// UNTUK MENAMILKAN DATA DIVISI EDIT
function get_data_divisi_delete(){
  ...
  $.ajax({
          ...
          success:function(response){
              ...
              $.each(response,function(key,value){
                ...
                data +=`
                <div class="form-check form-check-inline">
                                <input class="form-check-input checkdivisi_dl" for ="${divisi}" type="checkbox" id="${divisi}" name="divisi" value="${divisi}" required>
                                <label class="form-check-label" for ="${divisi}">${divisi}</label>
                    </div>
                `;

              });
              $("#divisi_delete").empty().html(data);  
          }
